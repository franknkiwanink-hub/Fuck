...
interface AgentConfig {
  ...
  autoAccept?: { enabled?: boolean; minPrice?: number };
  ...
  useEffect(() => {
    ...
    async function load() {
      ...
      try {
        ...
        if (agentConfig.autoAccept?.minPrice != null) setAcceptMin(String(agentConfig.autoAccept.minPrice));
  ...
  async function handleSave() {
    ...
    try {
      ...
      const config: AgentConfig & { updatedAt: number } = {
        ...
        autoAccept: { enabled: toggles.autoAccept, minPrice: parseFloat(acceptMin) || 0 },
        autoReject: {
        ...
        <div id="agentModalBody">
          <div id="agentModalContent">
            ...
            <ToggleCard
              ...
              desc="Automatically accept incoming offers above your minimum price threshold."
              ...
              extra={
                toggles.autoAccept ? (
                  <div className="agent-threshold-row">
                    <span className="agent-threshold-label">Min. price ($):</span>
                    <input
                      type="number"
                      className="agent-threshold-input"
                      placeholder="e.g. 500"
